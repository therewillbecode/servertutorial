...
describe('generateRangeBelow accepts borderline inputs', function(){
    ...
    it('when called with -3.5 should return 0', function(){
        expect(main.generateRangeBelow(-3.5)).to.equal(0);
    });

    it('when called with 5.5 should return 0', function(){
        expect(main.generateRangeBelow(5.5)).to.equal(0);
    });
});
